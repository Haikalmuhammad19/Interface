public class Lenovo implements Laptop {
    ...
    private static final int MAX_VOL = 100; // Anda harus mendefinisikan nilai maksimum volume
    private static final int MIN_VOL = 0;   // Anda juga harus mendefinisikan nilai minimum volume
